...
function create_if_block$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$7, 64, 8, 1789);
			add_location(button1, file$7, 65, 8, 1839);
			add_location(nav, file$7, 63, 4, 1775);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$7, 68, 4, 1897);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-nhp1xt");
			add_location(a, file$7, 72, 20, 2020);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$7, 73, 20, 2122);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$7, 71, 16, 1995);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$7, 60, 0, 1703);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
