...
function create_if_block$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$5, 82, 8, 2228);
			add_location(button1, file$5, 83, 8, 2278);
			add_location(button2, file$5, 84, 8, 2328);
			add_location(button3, file$5, 85, 8, 2378);
			add_location(button4, file$5, 86, 8, 2428);
			add_location(button5, file$5, 87, 8, 2478);
			add_location(button6, file$5, 88, 8, 2528);
			add_location(nav, file$5, 81, 4, 2214);
			attr_dev(ul, "class", "svelte-10dqnzh");
			add_location(ul, file$5, 91, 4, 2586);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-10dqnzh");
			add_location(a, file$5, 95, 20, 2709);
			attr_dev(span, "class", "svelte-10dqnzh");
			add_location(span, file$5, 96, 20, 2806);
			attr_dev(li, "class", "svelte-10dqnzh");
			add_location(li, file$5, 94, 16, 2684);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$5, 78, 0, 2148);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
