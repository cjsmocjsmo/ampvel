...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 63, 12, 1765);
			attr_dev(li0, "class", "svelte-1dvefsq");
			add_location(li0, file, 63, 8, 1761);
			add_location(p, file, 64, 12, 1801);
			attr_dev(li1, "class", "svelte-1dvefsq");
			add_location(li1, file, 64, 8, 1797);
			add_location(button0, file, 66, 10, 1848);
			add_location(button1, file, 67, 10, 1906);
			attr_dev(li2, "class", "svelte-1dvefsq");
			add_location(li2, file, 65, 8, 1833);
			attr_dev(ul, "id", ul_id_value = /*so*/ ctx[13].SongId);
			attr_dev(ul, "class", "svelte-1dvefsq");
			add_location(ul, file, 62, 4, 1732);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	async function getSongURL(x) {
		fetch(`${ampaddr}/PathArt?selected=${x}`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
