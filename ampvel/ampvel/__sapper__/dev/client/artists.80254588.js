...
function instance$1($$self, $$props, $$invalidate) {
	...
	async function getArtistInfo() {
		await fetch(`http://192.168.0.74:6789/ArtistInfo?selected=${selected}`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
