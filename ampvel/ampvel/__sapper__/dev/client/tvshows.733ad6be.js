...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$2, 61, 8, 1700);
			add_location(button1, file$2, 62, 8, 1749);
			add_location(nav, file$2, 60, 4, 1686);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$2, 65, 4, 1806);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 69, 20, 1929);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$2, 70, 20, 2029);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$2, 68, 16, 1904);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$2, 57, 0, 1620);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
