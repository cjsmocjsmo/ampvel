...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$1, 72, 8, 2079);
			add_location(button1, file$1, 73, 8, 2136);
			add_location(button2, file$1, 74, 8, 2193);
			add_location(button3, file$1, 75, 8, 2250);
			add_location(nav, file$1, 71, 4, 2065);
			attr_dev(ul, "class", "svelte-13j0val");
			add_location(ul, file$1, 78, 4, 2315);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$1, 82, 20, 2438);
			attr_dev(span, "class", "svelte-13j0val");
			add_location(span, file$1, 83, 20, 2536);
			attr_dev(li, "class", "svelte-13j0val");
			add_location(li, file$1, 81, 16, 2413);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$1, 68, 0, 1995);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
