...
function create_if_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$3, 67, 8, 1827);
			add_location(button1, file$3, 68, 8, 1883);
			add_location(button2, file$3, 69, 8, 1939);
			add_location(nav, file$3, 66, 4, 1813);
			attr_dev(ul, "class", "svelte-10dqnzh");
			add_location(ul, file$3, 72, 4, 2003);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$3, 76, 20, 2120);
			attr_dev(span, "class", "svelte-10dqnzh");
			add_location(span, file$3, 77, 20, 2222);
			attr_dev(li, "class", "svelte-10dqnzh");
			add_location(li, file$3, 75, 16, 2095);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$3, 63, 0, 1749);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
