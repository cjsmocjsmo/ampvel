...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 74, 12, 1982);
			attr_dev(li0, "class", "svelte-1dvefsq");
			add_location(li0, file, 74, 8, 1978);
			add_location(p, file, 75, 12, 2018);
			attr_dev(li1, "class", "svelte-1dvefsq");
			add_location(li1, file, 75, 8, 2014);
			add_location(button0, file, 77, 10, 2065);
			add_location(button1, file, 78, 10, 2123);
			attr_dev(li2, "class", "svelte-1dvefsq");
			add_location(li2, file, 76, 8, 2050);
			attr_dev(ul, "id", ul_id_value = /*so*/ ctx[15].SongId);
			attr_dev(ul, "class", "svelte-1dvefsq");
			add_location(ul, file, 73, 4, 1949);
		},
