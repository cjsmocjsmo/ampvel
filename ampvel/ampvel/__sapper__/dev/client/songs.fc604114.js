import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, g as globals, A as validate_each_argument, x as ampvel, K as songURLstore, L as artiststore, M as songstore, $ as songidstore, C as playlistidstore, v as validate_slots, a0 as each, e as element, t as text, p as space, c as claim_element, a as children, b as claim_text, f as detach_dev, r as claim_space, j as add_location, h as attr_dev, k as insert_dev, l as append_dev, m as listen_dev, N as is_function, u as set_data_dev, z as empty, n as noop, B as destroy_each, D as create_component, q as query_selector_all, E as claim_component, F as mount_component, G as transition_in, H as transition_out, I as destroy_component } from './client.654eb0e5.js';
import { P as PageComp } from './PageComp.ba196455.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 74, 12, 1988);
			attr_dev(li0, "class", "svelte-1dvefsq");
			add_location(li0, file, 74, 8, 1984);
			add_location(p, file, 75, 12, 2024);
			attr_dev(li1, "class", "svelte-1dvefsq");
			add_location(li1, file, 75, 8, 2020);
			add_location(button0, file, 77, 10, 2071);
			add_location(button1, file, 78, 10, 2129);
			attr_dev(li2, "class", "svelte-1dvefsq");
			add_location(li2, file, 76, 8, 2056);
			attr_dev(ul, "id", ul_id_value = /*so*/ ctx[15].SongId);
			attr_dev(ul, "class", "svelte-1dvefsq");
			add_location(ul, file, 73, 4, 1955);
		},
