...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$2, 61, 8, 1658);
			add_location(button1, file$2, 62, 8, 1707);
			add_location(nav, file$2, 60, 4, 1644);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$2, 65, 4, 1764);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 69, 20, 1887);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$2, 70, 20, 1987);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$2, 68, 16, 1862);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$2, 57, 0, 1578);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
