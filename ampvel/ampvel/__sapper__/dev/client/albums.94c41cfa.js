...
import { A as AlbumCard } from './AlbumCard.de940182.js';
...
function instance($$self, $$props, $$invalidate) {
	...
	async function getAlbumInfo() {
		await fetch(`http://192.168.0.74:6789/AlbumInfo?selected=${selected}`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
