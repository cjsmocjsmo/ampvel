...
function create_if_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$4, 82, 8, 2230);
			add_location(button1, file$4, 83, 8, 2280);
			add_location(button2, file$4, 84, 8, 2330);
			add_location(button3, file$4, 85, 8, 2380);
			add_location(button4, file$4, 86, 8, 2430);
			add_location(button5, file$4, 87, 8, 2480);
			add_location(button6, file$4, 88, 8, 2530);
			add_location(nav, file$4, 81, 4, 2216);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$4, 91, 4, 2588);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-nhp1xt");
			add_location(a, file$4, 95, 20, 2711);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$4, 96, 20, 2808);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$4, 94, 16, 2686);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$4(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$4, 78, 0, 2138);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
async function getPlayMedia$4(x) {
	let addr = `http://192.168.0.42:8888/playMediaReact?=${x}`;
