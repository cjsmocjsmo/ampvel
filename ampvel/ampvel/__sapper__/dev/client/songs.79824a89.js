...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h2, file, 74, 12, 2000);
			attr_dev(li0, "class", "svelte-1dvefsq");
			add_location(li0, file, 74, 8, 1996);
			add_location(p, file, 75, 12, 2036);
			attr_dev(li1, "class", "svelte-1dvefsq");
			add_location(li1, file, 75, 8, 2032);
			add_location(button0, file, 77, 10, 2083);
			add_location(button1, file, 78, 10, 2141);
			attr_dev(li2, "class", "svelte-1dvefsq");
			add_location(li2, file, 76, 8, 2068);
			attr_dev(ul, "id", ul_id_value = /*so*/ ctx[15].SongId);
			attr_dev(ul, "class", "svelte-1dvefsq");
			add_location(ul, file, 73, 4, 1967);
		},
