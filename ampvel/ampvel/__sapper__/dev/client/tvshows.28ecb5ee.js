...
function create_if_block$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$5, 81, 8, 2172);
			add_location(button1, file$5, 82, 8, 2222);
			add_location(button2, file$5, 83, 8, 2272);
			add_location(button3, file$5, 84, 8, 2322);
			add_location(button4, file$5, 85, 8, 2372);
			add_location(button5, file$5, 86, 8, 2422);
			add_location(button6, file$5, 87, 8, 2472);
			add_location(nav, file$5, 80, 4, 2158);
			attr_dev(ul, "class", "svelte-10dqnzh");
			add_location(ul, file$5, 90, 4, 2530);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-10dqnzh");
			add_location(a, file$5, 94, 20, 2653);
			attr_dev(span, "class", "svelte-10dqnzh");
			add_location(span, file$5, 95, 20, 2751);
			attr_dev(li, "class", "svelte-10dqnzh");
			add_location(li, file$5, 93, 16, 2628);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$5, 77, 0, 2092);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
