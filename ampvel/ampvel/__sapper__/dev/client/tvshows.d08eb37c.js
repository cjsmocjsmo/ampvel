...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(ul, file, 60, 4, 1617);
		},
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 64, 20, 1734);
			attr_dev(span, "class", "svelte-11aboip");
			add_location(span, file, 65, 20, 1834);
			attr_dev(li, "class", "svelte-11aboip");
			add_location(li, file, 63, 16, 1709);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 57, 0, 1549);
		},
		m: function mount(target, anchor) {
