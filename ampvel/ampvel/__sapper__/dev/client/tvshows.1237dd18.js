...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file, 78, 8, 2131);
			add_location(button1, file, 79, 8, 2187);
			add_location(button2, file, 80, 8, 2243);
			add_location(nav, file, 77, 4, 2117);
			attr_dev(ul, "class", "svelte-11aboip");
			add_location(ul, file, 82, 4, 2306);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen_dev(button2, "click", /*handleDiscovery3*/ ctx[5], false, false, false)
				];
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			if (dirty & /*showlist, handlePlayShow*/ 129) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(84:8) {#if showlistcount > 0}",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file, 86, 20, 2423);
			attr_dev(span, "class", "svelte-11aboip");
			add_location(span, file, 87, 20, 2521);
			attr_dev(li, "class", "svelte-11aboip");
			add_location(li, file, 85, 16, 2398);
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(
					...
					"click",
					function () {
						if (is_function(/*handlePlayShow*/ ctx[7](/*sshow*/ ctx[10].tvfspath))) /*handlePlayShow*/ ctx[7](/*sshow*/ ctx[10].tvfspath).apply(this, arguments);
					},
					false,
					false,
					false
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(85:12) {#each showlist as sshow }",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file, 74, 0, 2049);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$inject_state = $$props => {
		...
		if ("handleDiscovery3" in $$props) $$invalidate(5, handleDiscovery3 = $$props.handleDiscovery3);
		if ("fuckDis" in $$props) $$invalidate(6, fuckDis = $$props.fuckDis);
		if ("handlePlayShow" in $$props) $$invalidate(7, handlePlayShow = $$props.handlePlayShow);
	};
...
class Discovery extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, { LP: 8 });
...
function create_if_block$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$9, 73, 8, 2029);
			add_location(button1, file$9, 74, 8, 2087);
			add_location(nav, file$9, 72, 4, 2015);
			attr_dev(ul, "class", "svelte-11aboip");
			add_location(ul, file$9, 76, 4, 2152);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-11aboip");
			add_location(a, file$9, 80, 20, 2269);
			attr_dev(span, "class", "svelte-11aboip");
			add_location(span, file$9, 81, 20, 2367);
			attr_dev(li, "class", "svelte-11aboip");
			add_location(li, file$9, 79, 16, 2244);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$9, 69, 0, 1945);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
const file$b = "src/components/TVComps/LowerDecks.svelte";
...
function create_if_block$b(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*showlistcount*/ ctx[1] > 0 && create_if_block_1$b(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$b, 73, 8, 2022);
			add_location(button1, file$b, 74, 8, 2079);
			add_location(nav, file$b, 72, 4, 2008);
			attr_dev(ul, "class", "svelte-11aboip");
			add_location(ul, file$b, 76, 4, 2143);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
			...
			if (!mounted) {
				dispose = [
					listen_dev(button0, "click", /*handleLowerDecks1*/ ctx[3], false, false, false),
					listen_dev(button1, "click", /*handleLowerDecks2*/ ctx[4], false, false, false)
				];
...
function create_each_block$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-11aboip");
			add_location(a, file$b, 80, 20, 2260);
			attr_dev(span, "class", "svelte-11aboip");
			add_location(span, file$b, 81, 20, 2358);
			attr_dev(li, "class", "svelte-11aboip");
			add_location(li, file$b, 79, 16, 2235);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$b(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*visibleDis*/ ctx[2] && create_if_block$b(ctx);
	...
	const block = {
		...
		l: function claim(nodes) {
			button = claim_element(nodes, "BUTTON", {});
			var button_nodes = children(button);
			t0 = claim_text(button_nodes, "LowerDecks");
			button_nodes.forEach(detach_dev);
			t1 = claim_space(nodes);
			if (if_block) if_block.l(nodes);
			if_block_anchor = empty();
		...
		h: function hydrate() {
			add_location(button, file$b, 69, 0, 1939);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
async function getPlayMedia$b(x) {
	let y = "/media/pi/PiTB/media/TVShows" + x;
	console.log("this is y");
	console.log(y);
	let addr = `http://192.168.0.42:8888/playMediaReact?movie=${y}`;
...
function instance$b($$self, $$props, $$invalidate) {
	...
	let handlePlayShow = media => {
		if (LP) {
			...
			let promise = getPlayMedia$b(media).catch(err => console.log(err));
			$$invalidate(2, visibleDis = false);
		}
	};
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$b.warn(`<LowerDecks> was created with unknown prop '${key}'`);
	});
	...
	$$self.$inject_state = $$props => {
		...
		if ("showlistcount" in $$props) $$invalidate(1, showlistcount = $$props.showlistcount);
		if ("visibleDis" in $$props) $$invalidate(2, visibleDis = $$props.visibleDis);
		if ("handleLowerDecks1" in $$props) $$invalidate(3, handleLowerDecks1 = $$props.handleLowerDecks1);
		if ("handleLowerDecks2" in $$props) $$invalidate(4, handleLowerDecks2 = $$props.handleLowerDecks2);
		if ("fuckDis" in $$props) $$invalidate(5, fuckDis = $$props.fuckDis);
		if ("handlePlayShow" in $$props) $$invalidate(6, handlePlayShow = $$props.handlePlayShow);
	};
...
class LowerDecks extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$b, create_fragment$b, safe_not_equal, { LP: 7 });
		...
		if (/*LP*/ ctx[7] === undefined && !("LP" in props)) {
			console_1$b.warn("<LowerDecks> was created without expected prop 'LP'");
		}
	}

	get LP() {
		throw new Error("<LowerDecks>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}

	set LP(value) {
		throw new Error("<LowerDecks>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
	}
}

/* src/components/TVShowsListComp.svelte generated by Svelte v3.24.0 */
const file$c = "src/components/TVShowsListComp.svelte";
...
function create_fragment$c(ctx) {
	...
	const block = {
		c: function create() {
			...
			t10 = space();
			create_component(lowerdecks.$$.fragment);
			this.h();
		},
		l: function claim(nodes) {
			...
			claim_component(lowerdecks.$$.fragment, nav_nodes);
			nav_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			attr_dev(nav, "class", "svelte-14m8txd");
			add_location(nav, file$c, 17, 0, 854);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			...
			append_dev(nav, t10);
			mount_component(lowerdecks, nav, null);
			current = true;
		},
		p: function update(ctx, [dirty]) {
			...
			const lowerdecks_changes = {};
			if (dirty & /*LOCALPLAY*/ 1) lowerdecks_changes.LP = /*LOCALPLAY*/ ctx[0];
			lowerdecks.$set(lowerdecks_changes);
		},
		i: function intro(local) {
			...
			transition_in(lowerdecks.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			...
			transition_out(lowerdecks.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(nav);
...
class TVShowsListComp extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$c, create_fragment$c, safe_not_equal, { LOCALPLAY: 0 });
...
const file$d = "src/routes/tvshows.svelte";
...
function create_if_block_1$c(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(video, file$d, 36, 8, 825);
			attr_dev(div, "id", "vid2");
			attr_dev(div, "class", "svelte-calnre");
			add_location(div, file$d, 34, 4, 729);
		},
		m: function mount(target, anchor) {
...
function create_fragment$d(ctx) {
	...
	let mounted;
	let dispose;
	let if_block0 = /*visible3*/ ctx[0] && create_if_block_1$c(ctx);
	let if_block1 = !/*visible3*/ ctx[0] && create_if_block$c(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(input, file$d, 40, 0, 904);
			add_location(lable, file$d, 41, 0, 965);
		},
		m: function mount(target, anchor) {
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
