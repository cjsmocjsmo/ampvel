...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$2, 62, 8, 1708);
			add_location(button1, file$2, 63, 8, 1757);
			add_location(nav, file$2, 61, 4, 1694);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$2, 66, 4, 1814);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 70, 20, 1937);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$2, 71, 20, 2038);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$2, 69, 16, 1912);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$2, 58, 0, 1628);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
