...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(nav, file$8, 14, 0, 619);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
