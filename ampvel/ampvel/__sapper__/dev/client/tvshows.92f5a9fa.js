...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$2, 59, 8, 1648);
			add_location(button1, file$2, 60, 8, 1697);
			add_location(nav, file$2, 58, 4, 1634);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$2, 63, 4, 1754);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_if_block_1$2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(65:8) {#if ORVshowlistcount > 0}",
		ctx
	});
...
// (66:12) {#each ORVshowlist as sshow }
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 67, 20, 1877);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$2, 68, 20, 1977);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$2, 66, 16, 1852);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(66:12) {#each ORVshowlist as sshow }",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$2, 55, 0, 1568);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
function create_each_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file$3, 76, 20, 2171);
...
function create_each_block$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$7, 73, 20, 2126);
			attr_dev(li, "class", "svelte-nhp1xt");
