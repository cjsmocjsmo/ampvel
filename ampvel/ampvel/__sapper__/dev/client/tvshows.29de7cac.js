...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$1, 74, 8, 2104);
			add_location(button1, file$1, 75, 8, 2161);
			add_location(button2, file$1, 76, 8, 2218);
			add_location(button3, file$1, 77, 8, 2275);
			add_location(nav, file$1, 73, 4, 2090);
			attr_dev(ul, "class", "svelte-13j0val");
			add_location(ul, file$1, 80, 4, 2340);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$1, 84, 20, 2463);
			attr_dev(span, "class", "svelte-13j0val");
			add_location(span, file$1, 85, 20, 2561);
			attr_dev(li, "class", "svelte-13j0val");
			add_location(li, file$1, 83, 16, 2438);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$1, 70, 0, 2020);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
async function getPlayMedia$1(x) {
	let y = "/media/pi/PiTB/media/TVShows" + x;
	let addr = `http://192.168.0.42:8888/playMediaReact?=${y}`;
	console.log(addr);
