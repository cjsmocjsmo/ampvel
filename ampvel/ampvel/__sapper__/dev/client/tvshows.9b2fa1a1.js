...
function create_if_block$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$6, 71, 8, 1907);
			add_location(button1, file$6, 72, 8, 1956);
			add_location(button2, file$6, 73, 8, 2005);
			add_location(button3, file$6, 74, 8, 2054);
			add_location(nav, file$6, 70, 4, 1893);
			attr_dev(ul, "class", "svelte-1omye9l");
			add_location(ul, file$6, 77, 4, 2111);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$6, 81, 20, 2232);
			attr_dev(span, "class", "svelte-1omye9l");
			add_location(span, file$6, 82, 20, 2328);
			attr_dev(li, "class", "svelte-1omye9l");
			add_location(li, file$6, 80, 16, 2207);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$6, 67, 0, 1822);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
...
async function getPlayMedia$6(x) {
	let addr = `http://192.168.0.42:8888/playMediaReact?tvshowm=${x}`;
