...
function create_if_block$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$5, 82, 8, 2222);
			add_location(button1, file$5, 83, 8, 2272);
			add_location(button2, file$5, 84, 8, 2322);
			add_location(button3, file$5, 85, 8, 2372);
			add_location(button4, file$5, 86, 8, 2422);
			add_location(button5, file$5, 87, 8, 2472);
			add_location(button6, file$5, 88, 8, 2522);
			add_location(nav, file$5, 81, 4, 2208);
			attr_dev(ul, "class", "svelte-10dqnzh");
			add_location(ul, file$5, 91, 4, 2580);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-10dqnzh");
			add_location(a, file$5, 95, 20, 2703);
			attr_dev(span, "class", "svelte-10dqnzh");
			add_location(span, file$5, 96, 20, 2800);
			attr_dev(li, "class", "svelte-10dqnzh");
			add_location(li, file$5, 94, 16, 2678);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$5, 78, 0, 2142);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
