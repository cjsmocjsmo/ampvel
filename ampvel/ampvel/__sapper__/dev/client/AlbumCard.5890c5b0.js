...
function instance$1($$self, $$props, $$invalidate) {
	...
	let zoo = x => {
		...
		async function getSongURL() {
			fetch(`http://192.168.0.74:6789/PathArt?selected=${x}`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
				let oid = data.HttpMusicPath;
				FOOID = `http://192.168.0.74:6789` + oid;
				ARTIST = data.Artist;
				SONG = data.Song;
