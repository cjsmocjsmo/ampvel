...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$1, 69, 8, 1922);
			add_location(button1, file$1, 70, 8, 1979);
			add_location(button2, file$1, 71, 8, 2036);
			add_location(button3, file$1, 72, 8, 2093);
			add_location(nav, file$1, 68, 4, 1908);
			attr_dev(ul, "class", "svelte-13j0val");
			add_location(ul, file$1, 75, 4, 2158);
		},
		m: function mount(target, anchor) {
...
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$1, 79, 20, 2281);
			attr_dev(span, "class", "svelte-13j0val");
			add_location(span, file$1, 80, 20, 2380);
			attr_dev(li, "class", "svelte-13j0val");
			add_location(li, file$1, 78, 16, 2256);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$1, 65, 0, 1838);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
