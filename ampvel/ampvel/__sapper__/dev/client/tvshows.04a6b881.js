...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$1, 74, 8, 2109);
			add_location(button1, file$1, 75, 8, 2166);
			add_location(button2, file$1, 76, 8, 2223);
			add_location(button3, file$1, 77, 8, 2280);
			add_location(nav, file$1, 73, 4, 2095);
			attr_dev(ul, "class", "svelte-13j0val");
			add_location(ul, file$1, 80, 4, 2345);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_if_block_1$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(82:8) {#if Entshowlistcount > 0}",
		ctx
	});
...
// (83:12) {#each Entshowlist as sshow }
function create_each_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$1, 84, 20, 2468);
			attr_dev(span, "class", "svelte-13j0val");
			add_location(span, file$1, 85, 20, 2566);
			attr_dev(li, "class", "svelte-13j0val");
			add_location(li, file$1, 83, 16, 2443);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(83:12) {#each Entshowlist as sshow }",
		ctx
	});
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$1, 70, 0, 2025);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
