...
function create_if_block$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$6, 70, 8, 1838);
			add_location(button1, file$6, 71, 8, 1887);
			add_location(button2, file$6, 72, 8, 1936);
			add_location(button3, file$6, 73, 8, 1985);
			add_location(nav, file$6, 69, 4, 1824);
			attr_dev(ul, "class", "svelte-1omye9l");
			add_location(ul, file$6, 76, 4, 2042);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$6, 80, 20, 2163);
			attr_dev(span, "class", "svelte-1omye9l");
			add_location(span, file$6, 81, 20, 2260);
			attr_dev(li, "class", "svelte-1omye9l");
			add_location(li, file$6, 79, 16, 2138);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$6, 66, 0, 1753);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
