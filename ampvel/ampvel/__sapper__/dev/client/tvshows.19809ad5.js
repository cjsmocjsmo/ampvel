...
function create_if_block$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$7, 65, 8, 1845);
			add_location(button1, file$7, 66, 8, 1895);
			add_location(nav, file$7, 64, 4, 1831);
			attr_dev(ul, "class", "svelte-nhp1xt");
			add_location(ul, file$7, 69, 4, 1953);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-nhp1xt");
			add_location(a, file$7, 73, 20, 2076);
			attr_dev(span, "class", "svelte-nhp1xt");
			add_location(span, file$7, 74, 20, 2177);
			attr_dev(li, "class", "svelte-nhp1xt");
			add_location(li, file$7, 72, 16, 2051);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$7(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$7, 61, 0, 1759);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
