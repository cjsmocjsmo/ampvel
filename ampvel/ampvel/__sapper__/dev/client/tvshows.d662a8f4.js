...
function create_if_block$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button0, file$6, 71, 8, 1864);
			add_location(button1, file$6, 72, 8, 1913);
			add_location(button2, file$6, 73, 8, 1962);
			add_location(button3, file$6, 74, 8, 2011);
			add_location(nav, file$6, 70, 4, 1850);
			attr_dev(ul, "class", "svelte-1omye9l");
			add_location(ul, file$6, 77, 4, 2068);
		},
		m: function mount(target, anchor) {
			insert_dev(target, nav, anchor);
			append_dev(nav, button0);
...
function create_each_block$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$6, 81, 20, 2189);
			attr_dev(span, "class", "svelte-1omye9l");
			add_location(span, file$6, 82, 20, 2285);
			attr_dev(li, "class", "svelte-1omye9l");
			add_location(li, file$6, 80, 16, 2164);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			append_dev(li, a);
...
function create_fragment$6(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(button, file$6, 67, 0, 1779);
		},
		m: function mount(target, anchor) {
			insert_dev(target, button, anchor);
			append_dev(button, t0);
