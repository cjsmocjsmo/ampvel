...
function instance($$self, $$props, $$invalidate) {
	...
	async function getSongURL(x) {
		fetch(`http://192.168.0.74:67/PathArt?selected=${x}`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
