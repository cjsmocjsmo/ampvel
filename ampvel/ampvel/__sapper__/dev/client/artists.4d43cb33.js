...
function instance($$self, $$props, $$invalidate) {
	...
	async function getAlbumInfoalbums2() {
		fetch(`http://192.168.0.74:6789/ImageSongsForAlbum?selected=${selected}`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
